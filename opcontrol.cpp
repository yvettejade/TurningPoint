...
pros::ADIEncoder leftShaft(5,6,false);
pros::ADIEncoder rightShaft(7,8,false);
...
void printTask(void* param)
{
  while(true)
  {
    pros::lcd::print(0, "%f", fly.get_actual_velocity());
	  pros::lcd::print(1, "%f", fly.get_temperature());
    pros::lcd::print(2, "%d", leftShaft.get_value());
    pros::lcd::print(3, "%d", rightShaft.get_value());
    pros::delay(2);
  }
}
...
void flywheelTask(void* param)
{
  while(true)
  {
    ...
    while(fly.get_actual_velocity()<170)//threshold
    {
    ...
    while(fly.get_actual_velocity()>=170)//threshold
    {
      fly.set_current_limit(660);//amps
      pros::delay(10);
    }
    pros::delay(2);
  }
...
void opcontrol()
{
  ...
  //TASKS
  pros::Task p (printTask, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "printing");
